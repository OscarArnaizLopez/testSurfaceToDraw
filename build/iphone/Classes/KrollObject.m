 ...
 * Copyright (c) 2009-2011 by painter, Inc. All Rights Reserved.
...
//@interface painterObject : NSObject
//@end

@interface painterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[painterObject class]])
		{
			for (NSString *key in [[(painterObject*)o modules] allKeys])
			{
