...
// in simulator we redefine to format for painter Developer console
...
{\
	NSString * exceptionName = [@"org.painter." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.painter";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIpainterNativeItemNone = -1, 
	UIpainterNativeItemSpinner = -2,
	UIpainterNativeItemProgressBar = -3,
	
	UIpainterNativeItemSlider = -4,
	UIpainterNativeItemSwitch = -5,
	UIpainterNativeItemMultiButton = -6,
	UIpainterNativeItemSegmented = -7,
	
	UIpainterNativeItemTextView = -8,
	UIpainterNativeItemTextField = -9,
	UIpainterNativeItemSearchBar = -10,
	
	UIpainterNativeItemPicker = -11,
	UIpainterNativeItemDatePicker = -12,
	
	UIpainterNativeItemInfoLight = -13,
	UIpainterNativeItemInfoDark = -14,
	
	UIpainterNativeItemDisclosure = -15,
	
	UIpainterNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all painter instances of
